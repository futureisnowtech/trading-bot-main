...
def ask_ai(query: str) -> str:
    ...
    system_instruction = (
        ...
        "Table: open_positions (symbol TEXT, strategy TEXT, qty REAL, entry REAL, paper INTEGER, direction TEXT, etc.)\n"
        "IMPORTANT: Use qty NOT quantity. Use entry NOT entry_price. To estimate PnL: (current_price - entry) * qty.\n"
        "Table: trades (id, ts, strategy, symbol, qty, price, pnl_usd, paper)\n\n"
        f"### CONTEXT ###\n{context}"
    )
