# Open Questions — Legacy Archive

This file preserves the pre-2026-04-30 `brain/01_current_system/Open Questions.md`
content for audit trail and git-friendly historical reference.

The active operator file is now:
- `brain/01_current_system/Open Questions.md`

Important:
- any references below to "current", old versions, older brokers, or older readiness assumptions are intentionally stale historical statements
- do not use the historical text below as present-day operator truth

The content below is copied from the prior active file without reinterpretation.
