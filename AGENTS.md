...
- **Versioned City Firewall**: The source fallback blocks ABQ, ATL, AUS, BOS, CHS, CLT, DAL, DC, DET, HOU, LV, MCI, MCO, MIA, MKE, MSP, MSY, NY, OMA, PDX, PHL, PHX, RDU, SEA, SF, SLC, and STL, leaving CHI, DEN, LAX, OKC, and SAT enabled. An explicit `CITY_BLACKLIST` env value remains an intentional override.
