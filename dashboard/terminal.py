...
from config import (
    ...
    MARKET_TIMEZONE,
    MAX_DAILY_LOSS_PCT,
    MAX_TRADES_PER_DAY_EQUITY,
    MAX_TRADES_PER_DAY_CRYPTO,
...
def _top_bar(d: dict) -> list:
    ...
    loss_pct = (
        abs(d["pnl_today"]) / max(d["balance"], 1) * 100 if d["pnl_today"] < 0 else 0
    )
...
def _trades_panel(d: dict, n_rows: int) -> list:
    ...
    for t in d["recent_trades"]:
        ...
        lines.append(
            f" {DIM}{ts}{RST}  {icon}  {BOLD}{sym:<12}{RST}  {pnl_s}  {DIM}{strat}{RST}"
        )
    if len(lines) == 1:
...
def _demo_data() -> dict:
    ...
    return {
        ...
        "recent_trades": [
            {
                "ts": "2026-03-22T10:12:03",
                "action": "SELL",
                "symbol": "BTC-USDC",
                "pnl_usd": 0.43,
                "strategy": "crypto_macd",
            },
            {
                "ts": "2026-03-22T10:08:21",
                "action": "BUY",
                "symbol": "BTC-USDC",
                "pnl_usd": 0,
                "strategy": "crypto_macd",
        ...
        "signals": [
            {
                "ts": "2026-03-22T10:14:52",
                "signal": "BUY",
                "symbol": "AAPL",
                "confidence": 0.82,
                "reason": "3/3 agents BUY: funding neutral + squeeze fired + fee math clear",
                "acted_on": 1,
            },
            {
                "ts": "2026-03-22T10:13:11",
                "signal": "HOLD",
                "symbol": "ETH-USDC",
                "confidence": 0.45,
                "reason": "ADX < 20, choppy market — skipping",
                "acted_on": 0,
            },
            {
                "ts": "2026-03-22T10:10:03",
                "signal": "SELL",
                "symbol": "BTC-USDC",
                "confidence": 0.65,
                "reason": "RSI overbought + MACD histogram crossed below 0",
                "acted_on": 1,
            },
            {
                "ts": "2026-03-22T09:58:00",
                "signal": "BUY",
                "symbol": "ETH-USDC",
                "confidence": 0.70,
                "reason": "Workhorse + Classic MACD in consensus",
                "acted_on": 1,
            },
            {
                "ts": "2026-03-22T09:45:00",
                "signal": "BUY",
                "symbol": "AAPL",
                "confidence": 0.78,
                "reason": "Volume spike 220%, price > VWAP, KST zero-cross",
                "acted_on": 1,
            },
        ],
        "last_debate": {
        ...
        "events": [
            {
                "ts": "2026-03-22T10:15:20",
                "level": "INFO",
                "source": "equity_scan",
                "message": "AAPL signal BUY conf=82% — entering",
            },
            {
                "ts": "2026-03-22T10:10:45",
                "level": "INFO",
                "source": "crypto_scan",
                "message": "BTC-USDC debate 5/8 BUY — risk check passed",
            },
            {
                "ts": "2026-03-22T10:08:33",
                "level": "WARNING",
                "source": "exit_monitor",
                "message": "BTC-USDC trailing stop check — holding (3% profit cushion needed)",
            },
            {
                "ts": "2026-03-22T09:35:10",
                "level": "INFO",
                "source": "equity_scan",
                "message": "AAPL SELL — take profit hit $204.72 | P&L +$1.02",
            },
            {
                "ts": "2026-03-22T09:00:01",
                "level": "INFO",
                "source": "scheduler",
                "message": "System started — paper mode | AI debate: ON",
            },
            {
                "ts": "2026-03-22T08:30:00",
                "level": "INFO",
                "source": "premarket",
                "message": "SPY HTF=bullish ADX=28.4 — trend day expected",
            },
        ],
        "api_cost": 0.1247,
        "now": now,
