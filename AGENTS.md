...
| Spot execution | `spot_engine.py` → `execution/coinbase_spot_broker.py` | Coinbase spot scalp lane for BTC/ETH/SOL/XRP/LTC/DOGE/ADA/LINK; long-only; risk-from-stop sizing; maker-first/taker-fallback route; restart-safe spot state persisted |
