...
SCORE_FLOORS: dict[str, dict[str, float]] = {
    "BTC": {"TREND": 48.0, "NEUTRAL": 48.0, "CHOP": 48.0},
    "ETH": {"TREND": 48.0, "NEUTRAL": 48.0, "CHOP": 48.0},
    "SOL": {"TREND": 48.0, "NEUTRAL": 48.0, "CHOP": 48.0},
    "XRP": {"TREND": 48.0, "NEUTRAL": 48.0, "CHOP": 48.0},
    "LTC": {"TREND": 48.0, "NEUTRAL": 48.0, "CHOP": 48.0},
    "DOGE": {"TREND": 48.0, "NEUTRAL": 48.0, "CHOP": 48.0},
    "ADA": {"TREND": 48.0, "NEUTRAL": 48.0, "CHOP": 48.0},
    "LINK": {"TREND": 48.0, "NEUTRAL": 48.0, "CHOP": 48.0},
}
...
def get_symbol_grid() -> list[dict[str, Any]]:
    ...
    for sym in SPOT_SYMBOLS:
        ...
        floors = SCORE_FLOORS.get(sym, {"TREND": 48.0, "NEUTRAL": 48.0, "CHOP": 48.0})
        regime_key = (
            "CHOP"
