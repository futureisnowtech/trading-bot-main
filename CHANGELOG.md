...
- Renamed new strategy evidence to `weather_physics`, started RBI epoch `v19.20.0-deterministic-physics-path`, restored the swallowed `sqlite3` import for dynamic configuration, and synchronized operator/deploy/probability-path truth.
