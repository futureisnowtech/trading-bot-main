...
| [`execution/kalshi_execution_controller.py`](file:///Users/joshmacbookair2020/projects/algo_trading_final/execution/kalshi_execution_controller.py) | Python Script | Translates high-level trading decisions (TradeIntent) into REST orders; manages IOC/resting limit orders. | **ACTIVE** | Manages order parameters and sizing checks. | Yes | Order routing manager. |
